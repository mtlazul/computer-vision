...
## [load]
parser = argparse.ArgumentParser(description='Code for BRISK keypoint detector and descriptor extractor tutorial.')
...
kpts1, desc1 = brisk.detectAndCompute(img1, None)
kpts2, desc2 = brisk.detectAndCompute(img2, None)
## [BRISK]
...
cv.imwrite("brisk_result.png", res)

inlier_ratio = len(inliers1) / float(len(matched1))
print('BRISK Matching Results')
print('*******************************')
