...
## [load]
parser = argparse.ArgumentParser(description='Code for KAZE local features matching tutorial.')
...
## [KAZE]
kaze = cv.KAZE_create()
kpts1, desc1 = kaze.detectAndCompute(img1, None)
kpts2, desc2 = kaze.detectAndCompute(img2, None)
## [KAZE]
...
cv.imwrite("kaze_result.png", res)

inlier_ratio = len(inliers1) / float(len(matched1))
print('KAZE Matching Results')
print('*******************************')
